...
\begin{itemize}
    ...
    \item We release a reproducible training and analysis pipeline to facilitate further research on multilingual multimodal representation learning \url{https://github.com/mattiadri/crosslingual-contrastive}.
\end{itemize}
