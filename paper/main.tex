...
Our results show that image-pivoted contrastive learning consistently improves multilingual image--text retrieval across languages, including lower-resource ones, while preserving stable intrinsic dimensionality, improved isotropy, and non-degenerate feature statistics. We find that multilingual alignment emerges as a gradual convergence of representational structure under linear alignment, while nonlinear heads yield stronger retrieval gains without necessarily inducing deeper geometric convergence.
\end{abstract}
\clearpage
% ---------- Main Sections ----------
