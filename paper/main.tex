...
We find that multilingual alignment emerges as a gradual convergence of representational structure under linear alignment, while nonlinear heads yield stronger retrieval gains without necessarily inducing deeper geometric convergence or degenerate effects.
\end{abstract}
\clearpage
% ---------- Main Sections ----------
